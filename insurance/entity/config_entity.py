...
DataTransformationConfig=namedtuple('DataTransformationConfig',['bmi_classification','transformed_train_dir','transformed_test_dir','preprocessed_object_file_path'])
